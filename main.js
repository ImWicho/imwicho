...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_new-requirement_new-requirement_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/new-requirement/new-requirement.module */ 9971)).then(m => m.NewRequirementPageModule)
    },
    {
        path: 'start-requirement',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_start-requirement_start-requirement_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/start-requirement/start-requirement.module */ 9040)).then(m => m.StartRequirementPageModule)
    },
    {
        path: 'categories',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_categories_categories_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/categories/categories.module */ 3472)).then(m => m.CategoriesPageModule)
    },
    {
        path: '',
        redirectTo: 'splash',
